...
@router.get(path="/list/active", response_model=list[TutorListItem])
async def list_employees_staff(
    ...
    ).list_employees_staff(lang=lang)


@router.get(path="/list/active/punctuality/stats", response_model=list[EmployeePunctualityStatsItem])
...
@router.get(path="/{id}", response_model=TutorDetailItem)
...
@router.get(path="/list/punctuality", response_model=list[TutorFirstInItem])
...
@router.get(path="/{id}/punctuality/stats", response_model=EmployeePunctualityStatsItem)
...
@router.get(path="/list/punctuality/excel")
...
@router.put(
    path="/{id}/work-schedules/{schedule_id}",
    response_model=EmployeeWorkScheduleItem,
)
